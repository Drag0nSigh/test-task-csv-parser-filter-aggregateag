...
@pytest.fixture
def valid_csv_file():
    """Создаёт валидный CSV-файл в памяти для тестирования парсинга."""
    return io.StringIO(
...
def test_parser_valid_data(valid_csv_file):
    """Тест парсинг валидного CSV-файла с корректными данными."""
...
def test_parse_data_errors(
    ...
    """Тест обработки ошибок при парсинге CSV-файлов с валидными данными."""
    ...
    if expected_result is None:
        ...
        assert ([item.__dict__ for item in result[0]] ==
                [item.__dict__ for item in expected_result[0]])
